...
export const LEVEL_INFO: { [key: string]: LevelInfo } = {
    "play": {
        ...
        summary: {
            ...
            nl: "Speel Tetris zelf om het spel en de functies te ontdekken."
        },
        explanation: {
            en: `<h2>Welcome!</h2>
        <p>
        ...
        <p>
            First, start by playing Tetris yourself to get a feel for the
            game.
        </p>`,
            nl: `<h2>Welkom!</h2>
 <p>
...
Je leert hoe de computer het spel Tetris kan spelen en hoe die wordt 'getraind'.
 ...
 <ul>
 <li>
 <strong>Tetris</strong> is een klassiek videospel waarin je blokjes, <em>tetromino's</em> genaamd, in een raster plaatst.
            </li>
 <li>
    ...
    "feat1": {
        ...
        explanation: {
            en: `
                ...
                Computers are really fast and the AI can easily calculate all possible spots to place the tetromino.
                However, it does not know which moves are good and which are bad.
                </p>
                <p>
                ...
                We assign <strong>weights</strong> to these features to let the AI know which types of moves are good and which types are bad.
                </p>
                <p>
                In the following level you will start with two features: <strong>Holes</strong> and <strong>Landing Height</strong>.
                You can adjust the <strong>weights</strong> of these features using the sliders. For example, if you think a feature is desirable, you can increase its weight to make the AI prioritize it. Or, if you think a feature should be avoided, you can decrease its weight.
...
<p>
Hier komen <strong>kenmerken</strong> om de hoek kijken. Kenmerken zijn stukjes informatie die de AI helpen om beslissingen te nemen. Door <strong>waardes</strong> toe te kennen aan deze kenmerken laten we de AI weten welke soorten zetten goed zijn en welke juist slecht.</p>
<p>
...
Probeer met deze kenmerken honderd rijen weg te spelen. Voor uitleg over de kenmerken kun je op de <strong>[?]</strong>-knop klikken.</p>`
        },
    },
    "feat3": {
        name: {
        ...
        summary: {
            en: "Teach the AI to make a Tetris.",
            nl: "Leer de AI om een Tetris te maken."
        },
        explanation: {
            en: `<p>Try to make a <strong>Tetris</strong> by clearing four lines at once. 
Do this by adjusting weights of the <strong>Cleared Cells</strong> and <strong>Wells</strong> features. The values of the two other features are already given and cannot be changed.</p>`,
...
De waardes van twee andere kenmerken zijn al gegeven om je op weg te helpen. Deze kun je niet meer aanpassen.</p>`
        },
    },
    "feat4": {
        name: {
        ...
        summary: {
            en: "Reach level 29 using six features.",
            nl: "Behaal level 29 met zes kenmerken."
        },
        explanation: {
            en: `<p>
Now let's combine all the features. The hardest level in Tetris is level 29. Try to reach this level by adjusting the weights of the <strong>Cleared Cells</strong> and <strong>Wells</strong> features again. The weights of the other four features are already given.</p>`,
            nl: `<p>
Nu gaan we alle kenmerken combineren. In Tetris is het moeilijkste level 29. Probeer dit level te halen door opnieuw de waardes van de <strong>weggespeelde hokjes</strong> en <strong>putten</strong> aan te passen. De vier andere kenmerken zijn al gegeven.</p>`
        },
    },
    "training": {
        name: {
...
<p>
The average of the values of the top models is taken and then slightly adjusted with small, random changes. This creates a new generation of models that hopefully plays even better. This process is repeated until all models converge on the same features.</p>`,
            nl: `<p>In de praktijk is het (zoals je misschien gemerkt hebt) niet praktisch om alle kenmerken handmatig in te stellen. AI-modellen kunnen wel duizenden kenmerken hebben. In plaats daarvan worden AI's 'getraind' door een algoritme, wat je kunt zien in dit 'level'. In de visualisatie zie je steeds de beste versie van de AI van de vorige generatie. Merk op dat elke generatie steeds beter wordt in het spelen van Tetris.</p>
...
<p>
Het gemiddelde van de waardes van de topmodellen wordt vervolgens een beetje aangepast met kleine, willekeurige veranderingen. Zo ontstaat een nieuwe generatie modellen, die hopelijk nog beter speelt. Dit proces wordt herhaald totdat alle modellen op dezelfde kenmerken uitkomen.
</p>`
        },
    },
    "sandbox": {
