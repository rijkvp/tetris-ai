...
export class Simulator {
     ...
     */
    get steps() {
        const ret = wasm.__wbg_get_simulator_steps(this.__wbg_ptr);
     ...
     */
    set steps(arg0) {
        wasm.__wbg_set_simulator_steps(this.__wbg_ptr, arg0);
    }
    constructor() {
     ...
     */
    board_data() {
        const ret = wasm.simulator_board_data(this.__wbg_ptr);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('tetris_ai_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
